...
<div class="container">
    ...
    if($results != -1){
        ...
        <table class = "table table-striped table-bordered">
            <thead>
            <tr>
                <th scope = "col">label centre</th>
                <th scope = "col">label vaccin</th>
            ...
            <tbody>
            <?php
            // La liste des stock est dans la variable $results
            foreach ($results as $stock) {
                printf("<tr><td>%s</td><td>%s</td><td>%d</td></tr>", $stock["labelCentre"], $stock["labelVaccin"],$stock["quantite"]);
            }
            ?>
            </tbody>
        </table>
