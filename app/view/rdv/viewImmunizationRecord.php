...
<!-- ----- début viewImmunizationRecord.php -->
<?php
...
<body>
      ...
      <table class = "table table-striped table-bordered">
        <thead>
          <tr>
            ...
            <th scope = "col">Numéro de l'injection</th>
          </tr>
        </thead>
        <tbody>
            <?php
            ...
            foreach ($results as $tuple) {
             printf("<tr><td>%s</td><td>%s</td><td>%s</td><td>%d</td></tr>", $tuple["centreLabel"],$tuple["centreAdresse"],$tuple["vaccinLabel"],$tuple["injection"]);
            }
            ?>
        </tbody>
      </table>
  ...
  <!-- ----- fin viewImmunizationRecord.php -->
